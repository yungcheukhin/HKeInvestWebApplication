    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <asp:Button ID="emailBtn" runat="server" Text="Edit" class="btn-default col-md-2" />               
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-6">
                ...
                <asp:Button ID="buildingBtn" runat="server" Text="Edit" class="btn-default col-md-2" />     
            </div>
            ...
            <div class="col-md-6">
                ...
                <asp:Button ID="streetBtn" runat="server" Text="Edit" class="btn-default col-md-2" />     
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-6">
                ...
                <asp:Button ID="districtBtn" runat="server" Text="Edit" class="btn-default col-md-2" />          
            </div>
            ...
            <div class="col-md-6">
                ...
                <asp:Button ID="homePhoneBtn" runat="server" Text="Edit" class="btn-default col-md-2" />             
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-6">
                ...
                <asp:Button ID="homeFaxBtn" runat="server" Text="Edit" class="btn-default col-md-2" />            
            </div>
            ...
            <div class="col-md-6">
                ...
                <asp:Button ID="businessPhoneBtn" runat="server" Text="Edit" class="btn-default col-md-2" />            
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-6">
                ...
                <asp:Button ID="mobileBtn" runat="server" Text="Edit" class="btn-default col-md-2" />              
            </div>
            ...
            <div class="col-md-6">
                ...
                <asp:Button ID="citizenshipBtn" runat="server" Text="Edit" class="btn-default col-md-2" />           
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-6">
                ...
                <asp:Button ID="legalResidenceBtn" runat="server" Text="Edit" class="btn-default col-md-2" />             
            </div>
            ...
            <div class="col-md-6">
                ...
                <asp:Button ID="passportCountryOfIssueBtn" runat="server" Text="Edit" class="btn-default col-md-2" />            
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <asp:Button ID="confirmBtn" runat="server" Text="Confirm Edit Password" class="btn-default col-md-4" />            
            </div>
